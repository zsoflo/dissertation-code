...
function show_interaction_instructions() {
  ...
  var instruction_screen_interaction = {
    ...
    stimulus:
      ...
      Label it, so that your partner (the receiver) can select the correct object.</p> \
      <p style='text-align:left'>When you are the <b>RECEIVER</b>, you'll wait for the sender to \
      label an object. When they are finished, you'll see the sender's label and their array. Click on the object that you think the sender labelled.</p>",
    choices: ["Continue"],
    on_finish: function () {
