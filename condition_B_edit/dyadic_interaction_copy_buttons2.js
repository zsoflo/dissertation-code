...
var training_instructions = {
  ...
  stimulus:
    ...
    <p style='text-align:left'>Then, you will type the label for the object that you had just seen.</p>",
  choices: ["Continue"],
};
...
var testing_instructions = {
  ...
  stimulus:
    ...
    <p style='text-align:left'>You will receive feedback after each submitted response.</p>",
  choices: ["Continue"],
};
...
function show_interaction_instructions() {
  ...
  var instruction_screen_interaction = {
    ...
    stimulus:
      ...
      <p style='text-align:left'>Time t</p>\
      <p style='text-align:left'>You'll see a bordered object in an array of four,\
      and your job is to type a label to name it.</p>",
    choices: ["Continue"],
    on_finish: function () {
