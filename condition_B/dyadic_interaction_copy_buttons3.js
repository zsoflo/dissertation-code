...
var consent_screen = {
  ...
  then use that alien language to label more objects. It should take around 20-30 minutes to complete.</p>\
  \
...
function show_solo_matcher_instructions() {
  ...
  return instruction_screen_solo_matcher;
};

// Solo Matcher 

function matcher(target) {
  var target_image_as_html = '<img src="' + target + '.png">';  console.log(target_image_as_html)

  var subtrial = {
    type: jsPsychHtmlButtonResponseZH,
    stimulus: target,
    choices: [participant_final_label_set],
    ...
    on_finish: function (data) {
      ...
      label_selected = data.choices[button_number_selected]
