...
var instruction_screen_solo_director = {
  ...
  stimulus:
    ...
    <p style='text-align:left'>Time for you to take over!</p>\
    <p style='text-align:left'>You'll see one object bordered with pink (surrounded by three nasty distractors). The bordered object is your <b>target!</b></p>\
    <p style='text-align:left'><b>Name the target</b> using elements of the alien language that you have just learned. The elements can be combined in any way. They are simply buttons that you press to build your label (as in the Learning Phase).</p>\
    <p style='text-align:left'>Once your label is ready, click <b>DONE</b>.</p>\
...
var instruction_screen_solo_matcher = {
  type: jsPsychHtmlButtonResponseZH,
  stimulus:
    "<h3>The Quick Check...</h3>\
    <p style='text-align:left'>Almost done!</p>\
    <p style='text-align:left'>One-by-one, youll see each <b>target</b>. Below the target, you'll see <b>all the labels that you have created</b>.</p>\
    <p style='text-align:left'>Click on the label that you had created for that target earlier in the game. You won't see whether you were correct or not, but <b>don't stress</b>! This is just a super-duper quick check.</p>",
  choices: ["Continue"],
};
